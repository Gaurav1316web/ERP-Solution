...
and not exists(select 1 from TSPL_NIR_QC where TSPL_NIR_QC.MRN_No=TSPL_MRN_DETAIL.MRN_No and TSPL_NIR_QC.Document_No not in ('" + txtCode.Value + "'))  "
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        Try
            ...
            Dim sqlqry As String = "Select  TSPL_COMPANY_MASTER.Logo_Img2, TSPL_COMPANY_MASTER.Logo_Img, TSPL_ITEM_MASTER.NIR_QC,TSPL_COMPANY_MASTER.Comp_Name,TSPL_COMPANY_MASTER.Add1,TSPL_COMPANY_MASTER.ADD2,  '" + objCommonVar.CurrentUserCode + "' as UserName ,  ROW_NUMBER() OVER (ORDER BY TSPL_NIR_QC.Document_No) AS SrNo, Case When TSPL_MRN_HEAD.Status=1 Then 'OK' else 'Not OK' end as QC_Status,
...
where Document_No='" + txtCode.Value + "' and TSPL_ITEM_MASTER.NIR_QC=1 "
